...
const tapPlaceCursorComponent = {
  ...
  setupButtons() {
    ...
    button1.onclick = () => this.spawnModel("#treeModel");
    button2.onclick = () => this.spawnModel("#secondModel");
    button3.onclick = () => this.disableScalingForAll();
    button4.onclick = () => this.enableScalingForAll();
  },
  ...
  disableRotationForAll() {
    this.el.sceneEl.querySelectorAll("a-entity").forEach((entity) => {
